...
#SBATCH --exclusive
#SBATCH --time=4:00:00
#SBATCH -o 628.pop2_s/speccpu_pop2.%A.out
#SBATCH -e 628.pop2_s/speccpu_pop2.%A.err
...
cd "${SPECHPC_DIR}"
source shrc
go "628.pop2_s" "${RUN_SUBDIR}"

echo "Launching 628.pop2 with 256 MPI instances"

likwid-perfctr -f -c 0,128 -g ENERGY -t 500ms -O \
  -- srun --mpi=pmix --cpu-bind=cores --distribution=block:block ./speed_pop2 \
  2> "${RESULT_DIR}/speccpu_pop2.${SLURM_JOB_ID}.prof"

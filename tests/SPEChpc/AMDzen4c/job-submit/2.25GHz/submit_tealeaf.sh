...
#SBATCH --exclusive
#SBATCH --time=4:00:00
#SBATCH -o 618.tealeaf_s/spechpc_tealeaf.%A.out
#SBATCH -e 618.tealeaf_s/spechpc_tealeaf.%A.err
...
cd "${SPECHPC_DIR}"
source shrc
go "618.tealeaf_s" "${RUN_SUBDIR}"

echo "Launching 618.tealeaf with 256 MPI ranks"
